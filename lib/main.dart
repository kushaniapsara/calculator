//Student ID - IM/2021/109
import 'package:flutter/material.dart';
import 'dart:math'; // Import math library for square root function
...
class _CalculatorState extends State<Calculator> {
    ...
    return Container(
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          shape: CircleBorder(),
          backgroundColor: btncolor, // Button color
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ...
                calcbutton('√', Colors.orange, Colors.black), // Square root button
                calcbutton('/', Colors.teal, Colors.black),
              ],
            ),
            SizedBox(height: 10),
            Row(
              ...
              children: <Widget>[
                ...
                calcbutton('x', Colors.teal, Colors.black),
              ],
            ),
            SizedBox(height: 10),
            Row(
            ...
            Row(
              ...
              children: <Widget>[
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    shape: StadiumBorder(),
                    backgroundColor: Colors.white, // Button color here
  ...
  void calculation(btnText) {
    if (btnText == 'AC') {
      ...
      opr = btnText;
      result = '';
    } else if (btnText == '√') { // Square root logic
  ...
  String div() {
    if (numTwo == 0) {
      if (numOne == 0) {
        return 'Error!'; // Handle 0 / 0
      } else {
        return 'Error!'; // Handle number / 0
      }
    }
